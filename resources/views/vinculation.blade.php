...
<main>
    <div id="banner" style="background-image:url({{asset('pictures/line.png')}})">
        ...
        <img src="{{asset('pictures/banner-1.png')}}" class="img-fluid " alt="..." data-aos="fade-right"
            ...
            <div class="accordion-item mb-3">
                <h2 class="accordion-header" style="background-color:#344474; color:#fff">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        style="background-color:#344474; color:#fff">
                                    ...
                                    <div class="card mb-3 text-center"
                                        ...
                                        <div class="row g-0">
                                            <div class="col-md-4 p-2">
                                                <img src="{{asset('pictures/admin/institucion/'.$i->logo)}}"
                                                    class="rounded" alt="..." width="150" height="150">
                                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="card mb-3 text-center"
                                        ...
                                        <div class="row g-0 d-flex align-items-center">
                                            <div class="col-md-4 p-2">
                                                <img src="{{asset('pictures/admin/dependencia/'.$d->logo)}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card mb-3 text-center"
                                        ...
                                        <div class="row g-0">
                                            <div class="col-md-4 p-2">
                                                <img src="{{asset('pictures/admin/internacional/'.$i->logo)}}"
                                                    class="rounded" alt="..." width="130" height="130">
                                            </div>
                                            <div class="col-md-8 p-2">
                                                <div class="card-body">
                                                    <h6 class="card-title">{{$i->name}}</h6>
