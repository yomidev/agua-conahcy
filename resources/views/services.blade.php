                    ...
                    <div class="accordion-body">
                        ...
                        <ul class="nav nav-tabs nav-fill mb-3" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active fw-bold" id="ex2-tab-services-{{$t->id}}" data-bs-toggle="tab"
                                    href="#ex2-tabs-services-{{$t->id}}" role="tab"
                                    aria-controls="ex2-tabs-services-{{$t->id}}" aria-selected="true">
                                    Servicios
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link fw-bold" id="ex2-tab-infrastructure-{{$t->id}}" data-bs-toggle="tab"
                                    href="#ex2-tabs-infrastructure-{{$t->id}}" role="tab"
                                    aria-controls="ex2-tabs-infrastructure-{{$t->id}}" aria-selected="false">
                        ...
                        <div class="tab-content container" id="ex2-content">
                            <div class="tab-pane fade show active" id="ex2-tabs-services-{{$t->id}}" role="tabpanel"
                                aria-labelledby="ex2-tab-services-{{$t->id}}">
                                <div class="accordion accordion-flush" id="accordionFlushExample{{$t->id}}">
                                    ...
                                    <div class="accordion-item mb-2">
                                        <h2 class="accordion-header" style="background-color:#344474; color:#fff">
                                            <button class="accordion-button collapsed"
                                                ...
                                                data-bs-toggle="collapse" data-bs-target="#flush-collapse{{$s->id}}"
                                                aria-expanded="false" aria-controls="flush-collapse{{$s->id}}">
                                                {{$s->servicio}}
                                            </button>
                                        </h2>
                                        <div id="flush-collapse{{$s->id}}" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <p>{!!$s->description!!}</p>
                                                <p class="fw-bold">Para solicitar una cotizacion de este servicio, favor
                                                    de comunicarse al correo:
                                    ...
                                    <p class="fw-bold">Por el momento no se ofrece ningún servicio en esta institución.
                                    </p>
                                    @endif
                                </div>
                            </div>
                            <div class="tab-pane fade" id="ex2-tabs-infrastructure-{{$t->id}}" role="tabpanel"
                                aria-labelledby="ex2-tab-infrastructure-{{$t->id}}">
                                <div class="row">
                                    @foreach($equipment as $e)
                                    @if($e->id_tecnologico == $t->id)
                                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                        <div class="bg-white rounded shadow-sm h-100">
                                            <img src="{{asset('pictures/admin/infraestructura/'.$e->route)}}" alt=""
