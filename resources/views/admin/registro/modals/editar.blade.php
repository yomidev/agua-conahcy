<div class="modal fade" id="edit{{$r->id}}" tabindex="-1" role="dialog" aria-labelledby="ViewRLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="update_inv" action="{{route('registro_update',$r->id)}}" method="POST" enctype="multipart/form-data" id="createInv">
                    ...
                    <div class="form-step container" id="step-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mt-3">
                                ...
                                <input type="text" class="form-control" id="faculty" name="faculty" required placeholder="Ej. Sistemas Computacionales" value="{{ $r->faculty }}">
                            </div>
                            <div class="col-12 col-md-4 mt-3">
                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <input type="radio" name="participation" id="participation_1" value="1" {{ $r->participation == '1' ? 'checked' : '' }} required>&nbsp;
                                        <span>Asistente</span>
                                    </div>
                                    <div>
                                        <input type="radio" name="participation" id="participation_2" value="2" {{ $r->participation == '2' ? 'checked' : '' }} required>&nbsp;
                                        <span>Ponente oral</span>
                                    </div>
                                    <div>
                                        <input type="radio" name="participation" id="participation_3" value="3" {{ $r->participation == '3' ? 'checked' : '' }} required>&nbsp;
                                        <span>Presentación de cartel</span>
                                    </div>
                                    <div>
                                        <input type="radio" name="participation" id="participation_4" value="4" {{ $r->participation == '4' ? 'checked' : '' }} required>&nbsp;
                            ...
                            <div class="col-12 col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control" id="presentation" name="presentation" placeholder="Ej. Cuidado del Agua" value="{{ $r->presentation }}">
                            </div>
                            <div class="col-12 col-md-6 mt-3">
                                <label for="area" class="form-label">Área Tématica</label>
                                <input type="text" class="form-control" id="area" name="area" placeholder="Ej. Energías Renovables" value="{{ $r->area }}">
                            </div>
                            <div class="col-12 mt-3">
                                <label for="proof">¿Requiere constancia de participación?</label><br>
                                <input type="radio" name="proof" id="proof" value="1" {{ $r->proof == '1' ? 'checked' : '' }} required>&nbsp;
                                <span>Sí</span>
                                <input type="radio" name="proof" id="proof" value="0" {{ $r->proof == '0' ? 'checked' : '' }} required>&nbsp;
                                <span>No</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-step container" id="step-5">
                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <input type="radio" name="language" id="language_es" value="Español" {{ $r->language == 'Español' ? 'checked' : '' }} required>&nbsp;
                                        <span>Español</span>
                                    </div>
                                    <div>
                                        <input type="radio" name="language" id="language_en" value="Inglés" {{ $r->language == 'Inglés' ? 'checked' : '' }} required>&nbsp;
                                        <span>Inglés</span>
                                    </div>
                                    <div>
                                        <input type="radio" name="language" id="language_other" value="Otro" {{ (!in_array($r->language, ['Español', 'Inglés'])) ? 'checked' : '' }}>&nbsp;
                                        <span>Otro</span>
                                        <input type="text" name="other_language" id="other_language_input" class="form-control mt-1 {{ (!in_array($r->language, ['Español', 'Inglés'])) ? '' : 'd-none' }}" placeholder="Especificar otro idioma" value="{{ (!in_array($r->language, ['Español', 'Inglés'])) ? $r->language : '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
