...
@section('content_header')
    <h1 class="m-0 text-dark fw-bolder">Instituciones Internacionales</h1>
@stop
    ...
    <div class="card-body">
        ...
        <table class="table table-striped" id="tecin">
            ...
            <tbody>
                ...
                @include('admin.vinculacion.internacional.modals.view')
                @include('admin.vinculacion.internacional.modals.edit')
                @include('admin.vinculacion.internacional.modals.delete')
                @endforeach
            </tbody>
        </table>
        </div>
...
@include('admin.vinculacion.internacional.modals.create')
@stop
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ route('internacional') }}";
                        });
                    } else {
                        Swal.fire({
                            type: 'error',
