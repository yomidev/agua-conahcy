...
@section('content_header')
    <h1 class="m-0 text-dark fw-bolder">Servicios por Tecnológico</h1>
@stop
        ...
        <table class="table table-striped" id="tecin">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{$s->servicio}}</td>
                    <td>{!!$s->description!!}</td>
                    <td class="text-center">{{$s->tecnologico}}</td>
                    <td class="text-center">{{$s->email_contact}}</td>
                    <td class="text-center">
                        <button class="btn btn-warning" data-toggle="modal" data-target="#editService{{$s->id}}">
                            <i class="fa fa-pen" aria-hidden="true"></i>
                        </button>
                        <button class="btn btn-danger destroy" data-toggle="modal" data-target="#deleteService{{$s->id}}">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </button>
                    </td>
                </tr>
                @include('admin.servicios.modals.edit')
                @include('admin.servicios.modals.delete')
                @endforeach
            </tbody>
        </table>
        </div>
...
@include('admin.servicios.modals.create')
@stop
