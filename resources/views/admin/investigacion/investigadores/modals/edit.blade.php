<div class="modal fade" id="editR{{$r->id}}" tabindex="-1" role="dialog" aria-labelledby="editRLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="update_inv" action="{{route('investigadores_update',$r->id)}}" method="POST" enctype="multipart/form-data" id="createInv">
                <div class="modal-body">
                    <div class="alert alert-danger" style="display:none"></div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" required value="{{$r->nombre}}">
                        </div>
                        <div class="form-group">
                            <label for="name">Grado Académico*:</label>
                            <input type="text" name="grade" id="grade" class="form-control" required value="{{$r->grade}}">
                        </div>
                        <div class="form-group">
                            <label for="name">Especialidad*:</label>
                            <input type="text" name="especialidad" id="especialidad" class="form-control" required value="{{$r->specialization}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="investigacion" id="investigacion" cols="30" rows="10" required class="form-control">{{$r->investigation}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description">CV resumido:</label>
                            <textarea name="cv" id="cv" cols="30" rows="30" class="form-control">{{$r->cv}}</textarea>
                        </div>
                        <br>
                        <div class="form-group">
