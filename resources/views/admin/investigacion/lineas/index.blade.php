...
@section('title', 'Lineas de Investigacion')
...
@section('content_header')
    <h1 class="m-0 text-dark fw-bolder">Lineas de Investigacion por Tecnologico</h1>
@stop
    ...
    <div class="card-body">
        ...
        <table class="table table-striped" id="tecin">
            ...
            <tbody>
                ...
                @include('admin.investigacion.lineas.modals.edit')
                @include('admin.investigacion.lineas.modals.delete')
                @endforeach
            </tbody>
        </table>
        </div>
...
@include('admin.investigacion.lineas.modals.create')
@stop
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ route('investigacion') }}";
                        });
                    } else {
                        Swal.fire({
                            type: 'error',
