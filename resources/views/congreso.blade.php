...
<main>
    ...
    <div id="information-congreso"
        class="container-fluid d-flex justify-content-between align-items-center p-5 flex-wrap"
        style="background-color:#344474 !important">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p style="text-align: justify;" class="padding-responsive fs-5">
                    Generar espacios de diálogo, análisis, intercambio y formación, entre diversos agentes de la
                    sociedad sobre las
                    <b>contribuciones de la investigación</b> en temas relacionados con el cuidado del agua, los métodos
                    de tratamiento de agua potable y residual, así como las posibles alternativas para la recuperación y
                    reúso del vital líquido. Además de la implementación de tecnologías emergentes en el tratamiento y
    ...
    <div class="container mt-5">
        <h4 class="title text-center">PARTICIPA EN EL CONGRESO</h4>
        <p style="font-size:20px; text-align:center">Registra tu trabajo para <b>presentación oral o en cartel</b> del
            <b>1 al 30 de Julio
                de 2025.</b>
            <br>O regístrate como asistente del <b>1 de Julio al 23 de Septiembre de 2025</b> para poder conocer las
            tendencias actuales en el tema del agua y obtener constancia de participación.
        </p>
        <div class="row align-items-start mt-3">
            <div class="col-md-6">
                <a href="{{ asset('documents/pago_congreso.pdf') }}" target="_blank" download
            ...
            <div class="card plenary-card text-center">
                ...
                <div class="card-body">
                    ...
                    <p class="fw-bold">Dr. Satinder <br>Kaur Brar
                        <br><img src="{{asset('pictures/canada.png')}}" alt="Canadá" class="img-fluid"
                            style="max-width: 50px">
                    </p>
                    <a class="btn btn-primary" style="background-color:#344474 !important; border:none !important"
                        data-bs-toggle="modal" data-bs-target="#exampleModal"
                        data-researcher="satinder_kaur_brar">Curriculum Vitae</a>
                </div>
            </div>
            <div class="card plenary-card text-center">
                ...
                <div class="card-body">
                    <p class="fw-bold">Dra. Eva Rose <br>Kozak
                        <br><img src="{{asset('pictures/bandera.png')}}" alt="México" class="img-fluid"
                            style="max-width: 50px">
                    </p>
                    <a class="btn btn-primary" style="background-color:#344474 !important; border:none !important"
                        data-bs-toggle="modal" data-bs-target="#exampleModal2"
                        data-researcher="eva_rose_kozak">Curriculum Vitae</a>
                </div>
            </div>
            <div class="card plenary-card text-center">
                ...
                <div class="card-body">
                    <p class="fw-bold">Dra. Natalie <br>Mladenov
                        <br><img src="{{asset('pictures/estados-unidos-de-america.png')}}" alt="Estados Unidos"
                            class="img-fluid" style="max-width: 50px">
                    </p>
                    <a class="btn btn-primary" style="background-color:#344474 !important; border:none !important"
                        data-bs-toggle="modal" data-bs-target="#exampleModal3">Curriculum Vitae</a>
                </div>
            </div>
            <div class="card plenary-card text-center">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-primary" style="background-color:#344474 !important; border:none !important"
                        data-bs-toggle="modal" data-bs-target="#exampleModal4">Curriculum Vitae</a>
                </div>
            </div>
            <div class="card plenary-card text-center">
                ...
                <div class="card-body">
                    <p class="fw-bold">Prof. Rachel Louise Gomes
                        <br><img src="{{asset('pictures/reino-unido.png')}}" alt="Inglaterra" class="img-fluid"
                            style="max-width: 50px">
                    </p>
                    <a class="btn btn-primary" style="background-color:#344474 !important; border:none !important"
                        data-bs-toggle="modal" data-bs-target="#exampleModal5">Curriculum Vitae</a>
                </div>
            </div>
        </div>
    </div>
